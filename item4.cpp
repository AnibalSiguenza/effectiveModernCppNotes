// This items warns about the credibility of IDEs and standar function typeid to
// correctly state the deducted types
...
std::vector<Popo> createVector() { return std::vector<Popo>(5); }
...
int main(int argc, char *argv[]) {
  ...
  foo(&vpo[0]); // both the T and param are printed as PK4Popo (const Popo *)
                // which is incorrect. Correct ont is const Popo *const &param.
