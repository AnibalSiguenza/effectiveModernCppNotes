// This item warns us about the danger of using auto with proxy classes. For example with bool vectors
// it also suggest to make every conversion explicit
#include <bits/stdc++.h>
...
int main(int argc, char *argv[]) {
    ...
    auto b = static_cast<int>(1.321 * 3);  // here it is completely clear you wanted to cast to int
